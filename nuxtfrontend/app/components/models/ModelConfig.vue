            ...
            <form @submit.prevent="saveConfig">
                ...
                <div class="config-section">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            <input id="modelName" v-model="config.name" type="text" required
                        ...
                        <div class="form-group">
                            ...
                            <select id="modelType" v-model="config.modelType" required
                            ...
                            <p v-if="errors.modelType" class="mt-1 text-sm text-red-600">{{ errors.modelType }}</p>
                        </div>
                        ...
                        <div class="form-group md:col-span-2">
                            ...
                            <textarea id="modelDescription" v-model="config.description" rows="3"
                ...
                <div class="config-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="flex items-center space-x-4">
                            <input id="modelWeight" v-model.number="config.weight" type="range" min="0" max="1"
                ...
                <div class="config-section">
                    ...
                    <div class="parameters-list space-y-3">
                        <div v-for="(param, index) in config.parameters" :key="index"
                ...
                <div class="config-section">
                    ...
                    <div class="flex items-center">
                        <input id="modelActive" v-model="config.isActive" type="checkbox"
                            class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" />
                        <label for="modelActive" class="ml-2 block text-sm text-gray-700">
                            启用模型
                        </label>
                    </div>
                    <p class="mt-1 text-sm text-gray-500">
                        启用后模型将参与投票决策，停用后模型将不参与决策
                    </p>
                </div>
...
// 配置状态
const config = reactive<ModelInfo>({ ...defaultConfig })
...
const saveConfig = () => {
    ...
    errors.modelType = config.modelType === '' ? '请选择模型类型' : ''
...
watch(() => props.model, (newModel) => {
    if (newModel) {
        ...
        // 转换参数为数组格式用于编辑
        if (newModel.parameters && typeof newModel.parameters === 'object') {
