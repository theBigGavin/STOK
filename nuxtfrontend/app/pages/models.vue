      ...
      <UDashboardSection title="筛选条件" description="按模型类型、状态和关键词筛选">
        <div class="bg-white rounded-lg border border-gray-200 p-4">
          ...
          <div class="flex justify-between items-center mt-4">
            <div class="text-sm text-gray-500">共 {{ filteredModels.length }} 个模型</div>
                    ...
                    >
                      <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center gap-2">
                          ...
                          <UBadge v-if="model.isActive" color="success" variant="subtle" size="xs">
                            活跃
                          </UBadge>
                          <UBadge v-else color="neutral" variant="subtle" size="xs"> 停用 </UBadge>
                        </div>
                        <div v-if="model.description" class="text-xs text-gray-500 mt-1">
                          {{ model.description }}
                        </div>
                      </td>
                      <td class="px-6 py-4 whitespace-nowrap">
                        <UBadge :color="getModelTypeColor(model.modelType)" variant="subtle">
                      ...
                      <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center gap-2">
                          <UProgress
                            ...
                            :max="100"
                            size="sm"
                            :color="getWeightColor(model.weight)"
                            class="w-20"
                          />
                        ...
                        <div class="flex items-center gap-2">
                          ...
                          <UIcon
                            v-if="
                              ...
                              model.performanceMetrics.accuracy > 80
                            "
                          ...
                          <UIcon
                            v-else-if="
                              model.performanceMetrics?.accuracy &&
                              model.performanceMetrics.accuracy > 60
                            "
                            name="i-lucide-minus"
                            class="size-4 text-warning"
                          />
                          <UIcon v-else name="i-lucide-trending-down" class="size-4 text-error" />
                        </div>
                      </td>
                      <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex gap-1">
                          ...
                          <UButton
                            ...
                            size="sm"
                            title="配置参数"
                            @click.stop="showConfigModal(model)"
                          />
                          <UButton
                            icon="i-lucide-refresh-cw"
                            color="neutral"
              ...
              <div v-if="selectedModel" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <UBadge
                      :color="getModelTypeColor(selectedModel.modelType)"
                      variant="subtle"
                      class="ml-2"
                    >
                  ...
                  <div>
                    ...
                    <UBadge
                      :color="selectedModel.isActive ? 'success' : 'neutral'"
                      variant="subtle"
                      class="ml-2"
                    >
                  ...
                  <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                      ...
                      <span class="font-medium"
                        >{{ (selectedModel.performanceMetrics?.accuracy || 0).toFixed(1) }}%</span
                      >
                    </div>
                    <div class="flex justify-between">
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-4">
              <div v-if="selectedModel" class="space-y-4">
                ...
                <div class="border-t border-gray-200 pt-4">
                  ...
                  <div class="space-y-2 text-sm">
                    <div
                      v-for="(value, key) in selectedModel.parameters"
                      :key="key"
              ...
              <div v-if="selectedModel" class="space-y-4">
                ...
                <div class="text-center">
                  ...
                  <div class="grid grid-cols-2 gap-3 text-sm">
                    ...
                    <div class="text-center p-2 bg-gray-50 rounded">
                      <div class="text-lg font-semibold text-highlighted">
                        {{ (selectedModel.performanceMetrics?.maxDrawdown || 0).toFixed(1) }}%
                      </div>
                ...
                <div class="h-48 bg-gray-50 rounded-lg p-4">
                  <h4 class="text-sm font-medium text-highlighted mb-4">回测对比</h4>
