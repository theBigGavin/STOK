        ...
        <div class="config-section">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="form-group">
              ...
              />
              <p v-if="errors.initialCapital" class="mt-1 text-sm text-red-600">
        ...
        <div class="config-section">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="form-group">
              ...
              <input
                id="positionSize"
                v-model.number="config.parameters.positionSize"
                type="number"
                min="1"
                max="100"
                step="1"
            ...
            <div class="form-group">
              ...
              <input
                id="stopLoss"
                v-model.number="config.parameters.stopLoss"
                type="number"
                min="0"
                max="50"
                step="0.5"
            ...
            <div class="form-group">
              ...
              <input
                id="takeProfit"
                v-model.number="config.parameters.takeProfit"
                type="number"
                min="0"
                max="100"
                step="0.5"
        ...
        <div class="config-section">
          ...
          <div v-if="showAdvanced" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="form-group">
              ...
              <input
                id="transactionFee"
                v-model.number="config.parameters.transactionFee"
                type="number"
                min="0"
                max="1"
                step="0.01"
            ...
            <div class="form-group">
              ...
              <input
                id="slippage"
                v-model.number="config.parameters.slippage"
                type="number"
                min="0"
                max="5"
                step="0.01"
            ...
            <div class="form-group">
              ...
              <input
                id="minHoldDays"
                v-model.number="config.parameters.minHoldDays"
                type="number"
                min="0"
                max="30"
                step="1"
            ...
            <div class="form-group">
              ...
              <input
                id="maxPositionRatio"
                v-model.number="config.parameters.maxPositionRatio"
                type="number"
                min="0"
                max="100"
                step="1"
...
watch(
  ...
  models => {
    if (models.length > 0 && config.modelIds.length === 0) {
      // 默认选择所有活跃模型
      config.modelIds = models.filter(model => model.isActive).map(model => model.modelId);
    }
  },
  { immediate: true }
);
