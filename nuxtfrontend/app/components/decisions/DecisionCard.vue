    ...
    <div class="decision-card">
            ...
            <slot name="content">
                ...
                <div class="vote-distribution">
                    ...
                    <div class="vote-bars">
                        <div v-for="vote in voteDistribution" :key="vote.type" class="vote-bar-item">
                            ...
                            <div class="vote-bar">
                                <div class="vote-progress" :class="vote.colorClass"
                                    :style="{ width: `${vote.percentage}%` }"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="model-details">
                    ...
                    <div class="model-list">
                        <div v-for="model in decision.finalDecision.modelDetails" :key="model.modelId"
                            class="model-item">
                ...
                <!-- 风险评估 -->
                <div class="risk-assessment" v-if="decision.riskAssessment">
                    ...
                    <div class="risk-details">
                        ...
                        <div class="risk-warnings" v-if="decision.riskAssessment.warnings.length > 0">
        ...
        <div class="card-footer">
            <slot name="footer" :decision="decision">
                <div class="footer-actions">
                    <button @click="$emit('view-details', decision)"
                        class="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        查看详情
                    </button>
                    <button v-if="decision.riskAssessment.isApproved" @click="$emit('execute-trade', decision)"
                    ...
                    <button @click="$emit('backtest-decision', decision)"
                        class="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        回测分析
                    </button>
        ...
        <div v-if="error" class="error-overlay">
            <div class="error-message">
                ...
                <button @click="$emit('retry', decision)"
...
interface Emits {
    (e: 'view-details', decision: DecisionResult): void
    (e: 'execute-trade', decision: DecisionResult): void
    (e: 'backtest-decision', decision: DecisionResult): void
    (e: 'retry', decision: DecisionResult): void
}
