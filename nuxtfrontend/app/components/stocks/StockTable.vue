  ...
  <div class="stock-table">
    ...
    <div v-if="loading" class="loading-state">
      <div class="animate-pulse">
        <div v-for="n in 5" :key="n" class="h-4 bg-gray-200 rounded mb-3"></div>
      </div>
    </div>
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
              <slot name="actions" :stock="stock">
                <button
                  ...
                  @click="$emit('stock-select', stock)"
                >
                  查看
                </button>
                <button
                  class="text-green-600 hover:text-green-900"
                  @click="$emit('stock-analyze', stock)"
                >
                  分析
                </button>
              </slot>
...
interface Emits {
  ...
  (e: 'stock-select' | 'stock-analyze', stock: StockInfo): void;
}
