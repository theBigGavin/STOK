        ...
        <div v-else class="chart-container">
            ...
            <div v-if="showSummary" class="performance-summary">
                ...
                <div class="summary-grid">
                    ...
                    <div class="summary-item">
                        ...
                        <span class="summary-value" :class="averageReturnClass">
                            {{ averageReturn }}%
                        </span>
                    </div>
                    <div class="summary-item">
            ...
            <div v-if="showLegend" class="chart-legend">
                ...
                <div class="legend-items">
                    <div v-for="(model, index) in performanceData" :key="model.modelId" class="legend-item"
                ...
                tooltip: {
                    ...
                    callbacks: {
                        label: (context) => {
                            ...
                            if (selectedMetric.value === 'accuracy' || selectedMetric.value === 'return' || selectedMetric.value === 'drawdown') {
...
// 监听数据变化
watch([() => props.performanceData, chartType, selectedMetric], () => {
    initChart()
}, { deep: true })
