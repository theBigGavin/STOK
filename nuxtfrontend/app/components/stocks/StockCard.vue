        ...
        <div class="card-footer">
            <slot name="footer" :stock="stock">
                <div class="footer-actions">
                    <button @click="$emit('view-details', stock)"
                        class="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        查看详情
                    </button>
                    <button @click="$emit('analyze-stock', stock)"
...
interface Emits {
    (e: 'view-details', stock: StockInfo): void
    (e: 'analyze-stock', stock: StockInfo): void
    (e: 'retry', stock: StockInfo): void
}
