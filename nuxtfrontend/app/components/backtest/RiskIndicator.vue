        ...
        <div v-else class="indicator-content">
            ...
            <div class="overall-risk">
                ...
                <div class="risk-level">
                    <div class="risk-gauge">
                        ...
                        <div class="gauge-fill" :class="riskLevelClass"
                            :style="{ transform: `rotate(${gaugeRotation}deg)` }"></div>
                ...
                <div class="metrics-grid">
                    ...
                    <div class="metric-item">
                        ...
                        <div class="metric-bar">
                            <div class="metric-progress" :class="volatilityRiskClass"
                                :style="{ width: `${volatilityRiskScore}%` }"></div>
                        </div>
                    ...
                    <div class="metric-item">
                        ...
                        <div class="metric-bar">
                            <div class="metric-progress" :class="drawdownRiskClass"
                                :style="{ width: `${drawdownRiskScore}%` }"></div>
                        </div>
                        <div class="metric-description">
                            基于最大回撤评估的亏损风险
                        </div>
                    ...
                    <div class="metric-item">
                        ...
                        <div class="metric-bar">
                            <div class="metric-progress" :class="liquidityRiskClass"
                                :style="{ width: `${liquidityRiskScore}%` }"></div>
                        </div>
                        <div class="metric-description">
                            基于交易频率和成交量的流动性风险
                        </div>
                    ...
                    <div class="metric-item">
                        ...
                        <div class="metric-bar">
                            <div class="metric-progress" :class="concentrationRiskClass"
                                :style="{ width: `${concentrationRiskScore}%` }"></div>
                        </div>
                        <div class="metric-description">
                            基于持仓集中度的分散风险
                        </div>
            ...
            <div v-if="hasWarnings" class="risk-warnings">
                ...
                <div class="warnings-list">
                    <div v-for="warning in riskWarnings" :key="warning.type" class="warning-item"
                        :class="warning.severity">
                        <div class="warning-icon">
                            <svg v-if="warning.severity === 'high'" class="h-5 w-5 text-red-400" viewBox="0 0 20 20"
                                fill="currentColor">
                                <path fill-rule="evenodd"
                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z"
                                    clip-rule="evenodd" />
                            </svg>
                            <svg v-else-if="warning.severity === 'medium'" class="h-5 w-5 text-yellow-400"
            ...
            <div class="risk-recommendations">
                ...
                <div class="recommendations-list">
                    <div v-for="recommendation in riskRecommendations" :key="recommendation.type"
            ...
            <!-- 自定义风险内容插槽 -->
            <slot name="custom-risk" :riskData="riskData"></slot>
        </div>
